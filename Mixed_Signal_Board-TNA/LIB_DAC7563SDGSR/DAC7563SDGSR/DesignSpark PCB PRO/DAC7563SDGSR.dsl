...
(library Library_1
	...
	(symbolDef "DAC7563SDGSR" (originalName "DAC7563SDGSR")
		...
		(pin (pinNum 10) (pt 1800 mils -400 mils) (rotation 180) (pinLength 200 mils) (pinDisplay (dispPinName true)) (pinName (text (pt 1570 mils -425 mils) (rotation 0]) (justify "Right") (textStyleRef "Default"))
		))
	...
	(compDef "DAC7563SDGSR" (originalName "DAC7563SDGSR") (compHeader (numPins 10) (numParts 1) (refDesPrefix IC)
		...
		(compPin "10" (pinName "VREF IN / VREFOUT") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "http://www.ti.com/lit/gpn/dac7563")
		(attr "Height" "1.1 mm")
	)
